...
const CarOneScreen = ({navigation}) => {
    return (
      ...
      <Image source={require('../Images/carDetailsOne.jpg')}  style={styles.carsImage}></Image>
...
/* 
--------THE FIRST CAR DETAIILS PAGE STRUCTURE(WHERE THE FIRST CAR DETAILS ARE DISPLAYED)--------
...
/* 
--------THE FIRST CAR DETAIILS PAGE STYLE(WHERE THE FIRST CAR DETAILS ARE DISPLAYED)--------
TYPE YOUR COMMENT HERE, IN BETWEEN THE "/*"....TYPE THE STYLE OF YOUR DESIGN HERE, FOLLOW YOUR DESIGN ON FIGMA
AFTER READING, THE ABOVE TWO LINES, YOU CAN DELETE WHAT I WROTE AND START YOUR COMMENT 
*/
  
  
  export default CarOneScreen;