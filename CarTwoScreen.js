...
const CarTwoScreen = ({navigation}) => {
    return (
      ...
      <Image source={require('../Images/carDetailsTwo.jpg')}  style={styles.carsImage}></Image>
...
/* 
--------THE SECOND CAR DETAIILS PAGE STRUCTURE(WHERE THE SECOND CAR DETAILS ARE DISPLAYED)--------
...
const styles = StyleSheet.create({
  ...
  /* 
--------THE SECOND CAR DETAIILS PAGE STYLE(WHERE THE SECOND CAR DETAILS ARE DISPLAYED)--------
TYPE YOUR COMMENT HERE, IN BETWEEN THE "/*"....TYPE THE STYLE OF YOUR DESIGN HERE, FOLLOW YOUR DESIGN ON FIGMA
AFTER READING, THE ABOVE TWO LINES, YOU CAN DELETE WHAT I WROTE AND START YOUR COMMENT 
*/
  
  export default CarTwoScreen;